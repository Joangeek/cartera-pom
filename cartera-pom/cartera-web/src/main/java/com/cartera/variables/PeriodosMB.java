...
@ViewScoped
public class PeriodosMB<T> extends BaseControlador implements Serializable {
	...
	private TblacaPeriodo entity;
	private TblacaPeriodo selected;
	...
	public void inicializar() {
		...
		setEditar(false);
		setEstado(false);
		selected = new TblacaPeriodo();
		entity = new TblacaPeriodo();
	...
	public TblacaPeriodo getEntity() {
		return entity;
	}

	public void setEntity(TblacaPeriodo entity) {
		this.entity = entity;
	}

	public TblacaPeriodo getSelected() {
		return selected;
	}

	public void setSelected(TblacaPeriodo selected) {
