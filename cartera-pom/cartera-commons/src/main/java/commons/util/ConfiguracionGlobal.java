...
public final class ConfiguracionGlobal {
	...
	public static final String VPM_CODIGO_PRODUCTO = "UNI";
	public static final String URL_SUFIX = "xhtml";
	public static final String URL_UNI = "/acceso";
	public static final String URL_HOME = URL_UNI + "/home." + URL_SUFIX;
	public static final String URL_LOGOUT = URL_UNI + "/logout." + URL_SUFIX;
	public static final String URL_LOGIN = URL_UNI + "/login." + URL_SUFIX;
	public static final String URL_INDEX = URL_UNI + "/index." + URL_SUFIX;
	...
	public static final String AUTOEVALUACION = "autoevaluacion";
	 ...
	 * public static final long PARAM_ESATUS_SOLICITUD_FOLIO_AUTORIZADA =
	 * 170002; public static final long PARAM_ESATUS_SOLICITUD_FOLIO_RECHAZADA =
	 * 170003; public static final long PARAM_ESATUS_SOLICITUD_FOLIO_ATENDIDA =
	 * 180001; public static final String AUTORIZAR_MENSAJE_GUARDAR_EXITO =
	 * "mensajes.info.guardarExito"; public static final String GROWL_MENSAJES =
	 * "mensajes"; public static final String NUMERO_SOLICITUD_ALMACEN =
	 * "numeroSolicitudAlmacen"; public static final String CANTIDAD =
	 * "cantidad"; public static final String GROUP_FORMATO_IPS =
	 * "groupFormatoIps"; public static final String PIEZAS = "piezas"; public
	 * static final int UNO = 1; public static final int DOS = 2; public static
	 * final int TRES = 3;
	 */
	 ...
	 */
	/*
	 * public static final String MENSAJE_USUARIO_SIN_OFICINA =
	 * "comun.mensaje.usuario.sin.oficina"; public static final String
	 * MENSAJE_DATOS_EXITO="comun.menage.exito"; public static final String
	 * MENSAJE_RANGO_REPETIDO = "comun.mensaje.error.intervalo.translapado";
	 */
